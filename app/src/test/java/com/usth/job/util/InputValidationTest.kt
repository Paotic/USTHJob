...
class InputValidationTest {
    ...
    fun `isSapIdValid should return true for valid sapId`() {
        val (isValid, errorMessage) = InputValidation.isSapIdValid("001203002975")
    ...
    fun `isSapIdValid should return false for empty sapId`() {
        ...
        assertThat(errorMessage).isEqualTo("ID cannot be empty.")
    }
    ...
    fun `isSapIdValid should return false for sapId with length not equal to 11`() {
        ...
        assertThat(isValid).isFalse()
        assertThat(errorMessage).isEqualTo("ID must be 12 characters.")
    }
    ...
    fun `isSapIdValid should return false for sapId with non-digit characters`() {
        ...
        assertThat(isValid).isFalse()
        assertThat(errorMessage).isEqualTo("ID can only contain digits.")
    }
...
//        val (isValid, message) = InputValidation.isStateValid("Hanoi")
//        assertThat(isValid).isTrue()
//        assertThat(message).isEmpty()
//    }
//

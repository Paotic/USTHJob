...
import com.usth.job.databinding.ActivityJobViewBinding
import com.usth.job.home.viewmodel.StudentJobViewModel
import com.usth.job.util.LoadingDialog
import com.usth.job.util.Status.SUCCESS
import com.usth.job.util.Status.LOADING
import com.usth.job.util.Status.ERROR
import com.usth.job.util.createSalaryText
